    ...
    return (
        <>
            <div className='flex flex-col gap-2 justify-center items-start pb-[50px]'>
                ...
                <h1 className='font-sans font-bold text-[40px] text-very-dark-blue '>Fall Limited Edition <br />Sneakers</h1>
                ...
                <div className=' pt-4 md:pt-0 grid grid-cols-2 gap-2 md:gap-2 md:grid-cols-1 md:w-full'>
                    <div className="h-[40px] w-[180px] md:w-full text-center grid grid-cols-3 gap-6 place-content-center bg-light-grayish-blue px-4 rounded-sm">
                    ...
                    <button onClick={handleClickCart} className='w-[250px] h-[40px]  md:w-full text-center flex gap-4 justify-center items-center px-10 bg-orange rounded-sm font-sans font-bold text-very-dark-blue'>
