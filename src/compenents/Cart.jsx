                ...
                <div className="grid grid-rows-2 place-items-center  gap-y-3 p-4  ">
                    <div className="w-full grid grid-cols-[20%_70%_10%] gap-x-2 ">
                        ...
                        <div className='flex flex-col justify-center'>
                            ...
                            <h3 className='text-gray-400 font-sans font-normal text-[14px] '>$125.00 x 3 <span className='text-gray-800 font-sans font-bold '>${(125.00 * cartItems).toFixed(2)}</span></h3>
                        </div>
                        <button><img onClick={() => setCartItems(0)} className=' cursor-pointer h-[22px] mt-4' src={trashIcon} alt="" /></button>
                    </div>
