        ...
        <><div className='relative md:hidden'>
            <div className="fixed left-0 right-0 bottom-0 top-0 bg-black bg-opacity-60 text-white  ">
                ...
                <div className='grid place-items-center h-full  '>
                    ...
                    <button onClick={prevImage}  ><GrPrevious className='  absolute top-1/2 left-4 -translate-y-1 bg-white h-10 w-10 text-gray-800 hover:text-orange  rounded-full cursor-pointer' /></button>
                    <button onClick={nextImage}  ><GrNext className='  absolute top-1/2 right-4 -translate-y-1 bg-white h-10 w-10 text-gray-800 hover:text-orange  rounded-full cursor-pointer' /></button>
                </div>
